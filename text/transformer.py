...
def batchify(data, bsz):
    ...
    # compute number of batch
    nbatch = data.size(0) // bsz
    # trim off any extra elements that wouldn't exactly fit (remainders).
    # i.e. cutoff on  dim, start, end
    data = data.narrow(0, 0, nbatch * bsz)
    # divide the data across batches.
